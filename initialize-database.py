...
mongo = "mongodb+srv://recipe_user:1ZIXhHnLNObM2xLR@cluster0.kbccv.mongodb.net/recipe_db?retryWrites=true&w=majority"
...
def initial_database():
    ...
    # add users
    Connor = add_user('Connor', 'Stevenson', 'Connor@Connor.com', 'abc123', 'admin')
